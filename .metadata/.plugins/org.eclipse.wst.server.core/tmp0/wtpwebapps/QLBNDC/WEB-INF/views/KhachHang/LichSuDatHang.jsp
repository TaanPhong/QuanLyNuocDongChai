				...
				<div class="table-responsive">
					<table class="table table-bordered m-0">
						<thead>
							<tr>
								<!-- Set columns width -->
								<th class="text-center py-3 px-4" style="min-width: 200px;">Ngày
									Đặt</th>
								<th class="text-center py-3 px-4" style="min-width: 300px;">Địa
									Chỉ Giao Hàng</th>
						...
						<tbody>
							<c:forEach var="lsp" items="${listDH}">
								<tr>
									<td class="p-4">
										<div class="media align-items-center">

											<div class="media-body">${lsp.NGAYDAT}</div>
										</div>
									</td>
									<td class="text-center font-weight-semibold align-middle p-4">${lsp.DIACHINHAN}</td>

									<td class="text-center align-middle px-0"><a
										href="KhachHang/XemChiTietDonHang/${lsp.MADDH}.htm">Xem
											chi tiết</a></td>
								</tr>
							</c:forEach>
						</tbody>
