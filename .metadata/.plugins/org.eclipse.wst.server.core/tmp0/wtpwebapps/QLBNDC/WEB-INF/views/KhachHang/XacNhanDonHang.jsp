		...
		<div class="step-wizard">
			<ul class="step-wizard-list">
				<li class="step-wizard-item"><span class="progress-count">1</span>
					<span class="progress-label">CHỌN HÀNG</span></li>
				...
				<li class="step-wizard-item current-item"><span
					class="progress-count">3</span> <span class="progress-label">XÁC
						NHẬN ĐƠN HÀNG</span></li>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered m-0">
						...
						<tbody>
							<form action="KhachHang/ThanhToan.htm" , method="POST" id="form1">
								<c:forEach var="lsp" items="${listSanPham}">
									<tr>
										...
										<td class="text-right font-weight-semibold align-middle p-4">${listSL.get(listSanPham.indexOf(lsp))}</td>
										<td class="text-right font-weight-semibold align-middle p-4">${listSL.get(listSanPham.indexOf(lsp))*lsp.getGIA()}</td>
									</tr>
								</c:forEach>
							</form>
						</tbody>
				...
				<div class="float-right" style="margin-top: 20px;">
					<button type="button"
						...
						<a href="KhachHang/XacNhanHoaDon.htm"> Quay Lại </a>
					</button>
					<button type="submit" class="btn btn-lg btn-primary mt-2"
						form="form1" name="btnDH">Thanh Toán</button>
				</div>
