	...
	<div class="container px-3 my-5 clearfix">
			...
			<ul class="step-wizard-list">
				<li class="step-wizard-item"><span
					class="progress-count">1</span> <span class="progress-label">CHỌN
						HÀNG</span></li>
				<li class="step-wizard-item current-item"><span class="progress-count">2</span>
		...
		<div class="content"
			...
			<div class="bg-light p-5 rounded"
				...
				<form:form action="KhachHang/XacNhanThongTin.htm" modelAttribute="donDH"
					method="POST" id="form1">
					<div class="row">
						<div class="col-md-4">
							<label for="exampleFormControlInput1" class="form-label">Họ
								Người Nhận</label>
							<form:input path="HONGUOINHAN" type="text" class="form-control"
						...
						<div class="col-md-3">
							<label for="exampleFormControlInput1" class="form-label">Tên
								Người Nhận</label>
							<form:input path="TENNGUOINHAN" type="text" class="form-control"
								id="exampleFormControlInput1"
					...
					<div class="row" style="margin-top: 20px;">
						<div class="col-md-3">
							<label for="exampleFormControlInput1" class="form-label">Số
								Điện Thoại</label>
							<form:input path="SDTNGUOINHAN" type="number"
						...
						<div class="col-md-6">
							<label for="exampleFormControlInput1" class="form-label">Địa
								Chỉ </label>
							<form:input path="DIACHINHAN" type="text" class="form-control"
								id="exampleFormControlInput1"
		...
		<div class="float-right">
			<button type="button"
				...
				<a href="KhachHang/GioHang.htm"> Quay Lại </a>
			</button>
			<button type="submit" class="btn btn-lg btn-primary mt-2"
				form="form1">Bước Kế</button>
		</div>
