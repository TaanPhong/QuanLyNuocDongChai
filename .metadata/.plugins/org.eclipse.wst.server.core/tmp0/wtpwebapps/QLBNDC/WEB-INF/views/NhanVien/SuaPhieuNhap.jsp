	...
	<div class="main">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="table-responsive">
					...
					<c:url value="NhanVien/HieuChinhPhieuNhap.htm" var="pagedLink">
					...
					<table class="table table-bordered m-0">
						<thead>
							<tr>
								<!-- Set columns width -->
								<th class="text-center py-3 px-4" style="min-width: 200px;">Mã
									Phiếu Nhập</th>
						...
						<tbody>
							<c:forEach var="pd" items="${pagedListHolder.pageList}">
								<tr>
									<td class="p-4">${pd.getMAPN()}</td>
									<td class="text-right font-weight-semibold align-middle p-4">${pd.getNGAYNHAP()}</td>

									<td class="text-right font-weight-semibold align-middle p-4"><form:form
											action="NhanVien/HieuChinhPhieuNhap/${pd.getMAPN()}.htm?linkEdit"
											method="POST">
									...
									<td class="text-right font-weight-semibold align-middle p-4"><form:form
											action="NhanVien/HieuChinhPhieuNhap/${pd.getMAPN()}.htm?linkDelete"
											method="POST">
		...
		<div class="recentCustomers">
			<div class="row" style="height: 50px;">
				<button id="searchProduct" class="btn btn-warning" type="button">
					<a href="NhanVien/PhieuNhap.htm">Thêm Mới</a>
				</button>
				<button id="searchProduct" class="btn btn-warning active"
					style="margin-left: 20px;" type="button">
					<a href="NhanVien/HieuChinhPhieuNhap.htm">Hiệu Chỉnh</a>
				</button>
			</div>
			<div class="row" style="margin-top: 20px; margin-bottom: 20px;">
				<form action="NhanVien/HieuChinhPhieuNhap.htm" method="POST">
					<input name="masp" type="number" class="form-control"
						id="floatingInput" placeholder="Nhập mã phiếu nhập"
