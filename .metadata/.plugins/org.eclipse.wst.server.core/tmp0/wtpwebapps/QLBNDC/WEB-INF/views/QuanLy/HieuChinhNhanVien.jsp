		...
		<div class="main">
			...
			<div class="content" style="background-image: linear-gradient(45deg, rgb(2, 136, 209), rgb(38, 198, 218)) !important;">
				...
				<div class="bg-light p-5 rounded" style="background-image: linear-gradient(45deg,#ff6f00,#ffca28)!important;">
					${message}
					<form:form class="row g-3" modelAttribute="nhanVien"
						action="QuanLy/HieuChinhNhanVien.htm" method="POST">
						...
						<div class="row" style="margin-top: 20px;">
							...
							<div class="col-md-3">
								<label for="exampleFormControlInput1" class="form-label">Ngày
									Sinh </label>
								<input name="ngsinh" type="date" class="form-control" value="${ngaySinh}" />
						...
						<div class="row" style="margin-top: 20px;">
							<div class="col-md-4">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<form:radiobutton path="TRANGTHAI" id="nghiviec"
											value="0"/>
											<label for="nghiviec" class="form-label">Nghỉ Việc </label>
									</div>
									<div class="col-md-4">	
											<form:radiobutton path="TRANGTHAI" value="1" id="chuanghi"/>
							...
							<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-4">
											<form:radiobutton path="GIOITINH" id="nam" value="1"/>
										<label for="nam" class="form-label">Nam </label>
									</div>
									<div class="col-md-4">
											<form:radiobutton path="GIOITINH" value="0" id="nu"/>
