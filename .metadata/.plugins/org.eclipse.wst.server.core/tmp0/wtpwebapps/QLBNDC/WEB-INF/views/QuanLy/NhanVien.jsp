...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resource/QuanLy/css/NhanVien.css'/>" />
<link rel="stylesheet"
	...
	<div class="container-fluid">
		...
		<div class="main">
			...
			<div class="content">
				...
				<div class="navbar" style="background-image:linear-gradient(45deg,#43a047,#1de9b6)!important;">
					<h3>Quản lý nhân Viên</h3>
					<button type="button" class="btn btn-primary">
						<a href="QuanLy/ThemNhanVien.htm" style="color: white;">
							<span class="material-icons-sharp">
	                                person_add
	                            </span>
                            <span style="float: right; margin-top: 5px;">Thêm Nhân Viên</span>
						</a>
                        
					</button>
				</div>
				<div class="search">
					<form class="d-inline-flex" action="QuanLy/NhanVien.htm">
                    <div class="search-sp">
                        <input name="searchInput" type="search" placeholder="Nhập vào mã tên nhân viên" />
                    </div>
				...
				<div class="saff">
					...
					<c:url value="QuanLy/NhanVien.htm" var="pagedLink">
						<c:param name="p" value="~" />
					</c:url>
					<table class="table-saff">
						<thead>
							<tr>
								<th>Mã Nhân Viên</th>
								<th>Họ và Tên</th>
						...
						<tbody>
							<c:forEach var="pd" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td>${pd[3]}</td>
									<td>${pd[4]}</td>
									<td><a href="QuanLy/NhanVien/${pd[0]}.htm?linkEdit"> <span
											class="material-icons-sharp" style="color: black;">
												edit_note </span>
									</a></td>
									<td><a href="QuanLy/NhanVien/${pd[0]}.htm?linkDelete"> <span
											class="material-icons-sharp" style="color: black;">delete</span>
									</a></td>
								</tr>
							</c:forEach>
						</tbody>
