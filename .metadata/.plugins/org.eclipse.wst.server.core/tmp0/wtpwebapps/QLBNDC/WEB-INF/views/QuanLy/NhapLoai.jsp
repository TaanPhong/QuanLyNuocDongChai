	...
	<div class="container-fluid">
		...
		<aside>
			...
			<div class="sidebar">
				<a href="QuanLy/TrangChu.htm"> <span
					...
					<h3>Doanh số</h3>
				</a> <a href="QuanLy/Loai.htm" class="active"> <span
		...
		<div class="main">
			...
			<div class="content"
				...
				<h2 style="color: red;">Loại Sản Phẩm</h2>
				<div class="bg-light p-5 rounded"
					...
					<form:form class="row g-3" modelAttribute="loai"
						action="QuanLy/NhapLoai.htm?id=${loai.MALOAI}"
						method="POST" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-4">
								<label for="exampleFormControlInput1" class="form-label">Tên Loại Sản Phẩm</label>
