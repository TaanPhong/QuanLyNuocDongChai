...
<link rel="stylesheet"
	href="<c:url value ='/resource/Home/css/style.css'/>" />
<!--font roboto-->
...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarReponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="Home/index.htm" class="nav-link">Trang
							chủ</a></li>
					<li class="nav-item active"><a href="Login/Login.htm" class="nav-link">Giỏ
							hàng</a></li>
					<li class="nav-item active"><a href="Login/Login.htm" class="nav-link">Tài Khoản</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<section class="py-5 bg-light">
		<div class="container px-4 px-lg-5 mt-5">
			<h2 class="fw-bolder mb-4">Sản phẩm nước giải khát</h2>
			<div
							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto" padding-bottom="10px"
										href="Home/XemChiTiet/${sp.MASP}.htm">Xem chi tiết</a>
								</div>
								<div class="text-center">
									<a class="btn btn-outline-dark mt-auto" href="Login/Login.htm">Thêm vào
										giỏ</a>
								</div>
							</div>
						</div>
