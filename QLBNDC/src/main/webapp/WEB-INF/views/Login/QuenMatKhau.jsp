			...
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card border-0 shadow rounded-3 my-5">
					<div class="card-body p-4 p-sm-5">
						...
						<form action="Login/QuenMatKhau.htm" method="POST">
							<div class="form-floating mb-3">
									<input type="text" name="mail" class="form-control" id="floatingInput"
							...
							<div class="form-floating mb-3">
									<input type="text" name="tenDN" class="form-control" id="floatingInput"
										placeholder="name@example.com">
							...
							<div class="d-grid btn-login">
								<button
									...
									type="submit">Gửi Về Mail</button>
							</div>
						</form>
					</div>
				</div>
