		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarReponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="Home/index.htm"
						class="nav-link"
						style="text-decoration: none; color: white; font-size: 20px; font-weight: 650; margin-right: 5px;">Trang
							chủ</a></li>
				</ul>
			</div>
		</div>
						...
						<form:form action="Login/Sig_in.htm" modelAttribute="taiKhoan"
							...
							<div class="form-floating mb-3">
								<input name="tenDN" type="text" class="form-control"
									...
									for="floatingInput">Tên đăng nhập</label> <label
									class="invalid-feedback">Tên đăng nhập không chính xác</label>
							...
							<div class="form-check mb-3">
								<a href="Login/QuenMK.htm" style="margin-left: 200px;">Quên
									mật khẩu</a>
							</div>
							<c:if test="${cap > 2}">
								<div class="row  px-7 m-4">
									...
									<input class="form-control" name="captcha" type="text"
										placeholder="Vui lòng nhập Captcha"
										/ style="margin-top: 20px;">
									<div style="color: red;">${reCatra}</div>
								</div>
							</c:if>
