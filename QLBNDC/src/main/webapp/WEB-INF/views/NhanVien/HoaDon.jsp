		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item "><a class="nav-link link active" href="NhanVien/HoaDon.htm">Hóa
							Đơn</a></li>
					<li class="nav-item"><a class="nav-link link" href="NhanVien/PhieuNhap.htm">Phiếu
							Nhập</a></li>
					<li class="nav-item"><a class="nav-link link" href="NhanVien/XemThongTinCaNhan.htm">Thông Tin
							cá nhân</a></li>
					<li class="nav-item"><a class="nav-link link" href="Login/LogOut.htm">Đăng
							Xuất</a></li>
				</ul>
			</div>
		</div>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered m-0">
						...
						<tbody>
							<form action="NhanVien/HoaDon.htm", method="POST" id="form1">
							<c:forEach var="lsp" items="${listSP}">
								...
								<a href="NhanVien/HoaDon/${lsp.getMASP()}.htm"
	...
	<div class="recentCustomers">
		<div class="row" style="height: 50px;">
			<button id="searchProduct"
				class="btn btn-danger active" type="button">
				<a href="NhanVien/HoaDon.htm">Thêm Mới</a>
			</button>
			<button id="searchProduct"
				class="btn btn-danger" type="button" style="margin-left: 20px;">
...
<!-- 			<form action="NhanVien/HoaDon.htm" method="POST"> -->
				...
				<button name="btnsearch" id="searchProduct" form="form1"
					class="btn btn-warning" type="submit" style="height: 50px;">Tìm
					Kiếm</button>
<!-- 			</form> -->
		</div>
...
<!-- 			<form action="NhanVien/HoaDon.htm" method="POST"> -->
				<button name="btnthemsp" id="searchProduct" form="form1"
					class="btn btn-info" type="submit" style="height: 50px;">Thêm
					Vào Hóa Đơn</button>
<!-- 			</form> -->
		</div>
		<div class="row" style="margin-top: 20px;">
<!-- 			<form action="NhanVien/HoaDon.htm" method="POST"> -->
				<button name="btntaoHD" id="searchProduct" form="form1"
					class="btn btn-dark" type="submit" style="height: 50px;">Xuất
					Hóa Đơn</button>
<!-- 			</form> -->
		</div>
		<c:if test="${id > 0}">
