	...
	<div class="main">
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered m-0">
						...
						<tbody>
							<form action="NhanVien/SuaChiTietPhieuNhap.htm" , method="POST" id="form1">
								<c:forEach var="lsp" items="${listSP}">
									<tr>
										...
										<a href="NhanVien/SuaChiTietPhieuNhap/${lsp.getMASP()}.htm"
		...
		<div class="recentCustomers">
			<div class="row" style="height: 50px;">
				<button id="searchProduct" class="btn btn-danger"
					type="button">
					<a href="NhanVien/PhieuNhap.htm">Thêm Mới</a>
				</button>
				<button id="searchProduct" class="btn btn-danger active" style="margin-left: 20px;"
					type="button">
