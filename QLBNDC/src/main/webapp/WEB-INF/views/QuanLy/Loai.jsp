		...
		<aside>
			...
			<div class="sidebar">
				<a href="QuanLy/TrangChu.htm"> <span
					...
					<h3>Doanh số</h3>
				</a> <a href="QuanLy/Loai.htm" class="active"> <span class="material-icons-sharp">card_travel</span>
					<h3>Loại Sản Phẩm</h3>
			...
			<div class="content">
				...
				<div class="navbar"
					...
					<button type="button" class="btn btn-primary">
						<a href="QuanLy/ThemLoai.htm" style="color: red;"> <span
							class="material-icons-sharp"> local_drink </span> <span
							style="float: right; margin-top: 5px;">Thêm Loại</span>
						</a>
				...
				<div class="search">
					<form class="d-inline-flex" action="QuanLy/Loai.htm">
						<div class="search-kh">
							<input name="searchInput" type="search"
								placeholder="Nhập vào tên loại" />
						</div>
				...
				<div class="customer">
					...
					<c:url value="QuanLy/Loai.htm" var="pagedLink">
						...
						<tbody>
							<c:forEach var="pd" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td>${pd.TENLOAI}</td>
									<td><form:form
											action="QuanLy/Loai/${pd.MALOAI}.htm?linkEdit" method="POST">
											<button type="submit" class="btn btn-warning">
												<span class="material-icons-sharp" style="color: black;">edit_note</span>
											</button>
										</form:form></td>
									<td><form:form
											action="QuanLy/Loai/${pd.MALOAI}.htm?linkDelete"
											method="POST">
