		...
		<div class="main">
			...
			<div class="content"
				...
				<div class="bg-light p-5 rounded"
					...
					<form:form class="row g-3" modelAttribute="hang"
						action="QuanLy/NhapHang.htm?id=${hang.MAHANG}"
						method="POST" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-4">
								<label for="exampleFormControlInput1" class="form-label">Tên Hãng</label>
