...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resource/QuanLy/css/SanPham.css'/>" />
</head>
			...
			<div class="content">
				...
				<div class="navbar"
					...
					<button type="button" class="btn btn-primary">
						<a href="QuanLy/ThemSanPham.htm" style="color: red;"> <span
							class="material-icons-sharp"> local_drink </span> <span
							style="float: right; margin-top: 5px;">Thêm sản phẩm</span>
						</a>
				...
				<div class="search">
					<form class="d-inline-flex" action="QuanLy/SanPham.htm">
						<div class="search-sp">
				...
				<div class="product">
					...
					<c:url value="QuanLy/SanPham.htm" var="pagedLink">
						...
						<tbody>
							<c:forEach var="pd" items="${pagedListHolder.pageList}">
								<tr>
									...
									<td>${pd[5]}</td>
									<td><form:form
											action="QuanLy/SanPham/${pd[0]}.htm?linkEdit" method="POST">
											<button type="submit" class="btn btn-warning">
												<span class="material-icons-sharp" style="color: black;">edit_note</span>
											</button>
										</form:form></td>
									<td><form:form
											action="QuanLy/SanPham/${pd[0]}.htm?linkDelete" method="POST">
