...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resource/QuanLy/css/QuanLy-TonKho.css'/>" />
<link rel="stylesheet"
...
<body>
	<div class="container-fluid">
		...
		<aside>
			...
			<div class="sidebar">
				<a href="QuanLy/TrangChu.htm" > <span
					...
					<h3>Nhập kho</h3>
				</a> <a href="QuanLy/TonKho.htm" class="active"> <span class="material-icons-sharp">store</span>
					<h3>Tồn kho</h3>
		...
		<div class="main">
			...
			<!-- start content -->
			<div class="content">
			 <div class="navbar" style="margin-top: 70px; background-image: -webkit-linear-gradient(45deg,#ff5252,#f48fb1)!important;">
				...
				<div class="cardBox">
					<div class="card" style="background-image: linear-gradient(45deg, rgb(2, 136, 209), rgb(38, 198, 218)) !important;">
						<div>
							<div class="number">${soSLTON}</div>
							<div class="cardName">Số lượng tồn</div>
						</div>
						<div class="iconBox">
					...
					<div class="card" style="background-image: -webkit-linear-gradient(45deg,#ff5252,#f48fb1)!important;">
						<div>
							<div class="number">${tongVonTonKho}</div>
							<div class="cardName">Tổng vốn tồn kho</div>
						</div>
						<div class="iconBox">
					...
					<div class="card" style="background-image: linear-gradient(45deg,#ff6f00,#ffca28)!important;">
						<div>
							<div class="number">${tongGiaTriTonKho }</div>
							<div class="cardName">Tổng giá trị tồn kho</div>
						</div>
						<div class="iconBox">
				...
				<div class="search">
					<form class="d-inline-flex" action="QuanLy/TonKho.htm">
                    <div class="search-sp">
                        <input name="searchInput" type="search" placeholder="Nhập vào tên sản phẩm" />
                    </div>
				...
				<div class="product">
					...
					<c:url value="QuanLy/TonKho.htm" var="pagedLink">
